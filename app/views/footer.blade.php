<div class="contact clearfix" id="contact">
	<div class="col-50 emailarea">
		...
		<p class="email"><a href="mailto:marksuperales123@yahoo.com.ph"><i class="fa fa-skype"></i> marksuperales123@yahoo.com.ph</p>
	</div>
...
<div class="modal">
	<div class="modal-header">
		...
		<svg style="width:80px">
		    <line x1="0" y1="70" x2="70" y2="0"  stroke="rgba(0,0,0,0.2)" stroke-width="1"/>
		    <line x1="0" y1="0"  x2="70" y2="70" stroke="rgba(0,0,0,0.2)" stroke-width="1"/>
		</svg>
		</a>
	</div>
